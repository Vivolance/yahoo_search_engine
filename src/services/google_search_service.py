"""
When it comes to experimenting with features, the first thing to do is a prototype. What is the most minimal thing to call it a feature, w
...
from retry import retry  # library to retry functions, typically database calls and api
...
class GoogleSearchService:
    ...
    def google_search(search_term: str) -> str | None:
        ...
        try:
            ...
            Warning -> something is unstable
            Error -> something blew up
            Critical -> time to work at macs
            Most Dangerous
...
if __name__ == "__main__":
    ...
    response: str = GoogleSearchService.google_search(search_term)
    # print(response)
